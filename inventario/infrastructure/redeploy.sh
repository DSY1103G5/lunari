...
# LUNARi Inventario Service - Quick Redeploy Script
...
# Header
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}  Inventario Service - Redeploy${NC}"
echo -e "${GREEN}========================================${NC}\n"
...
# Build the new image
log_info "Building Inventario Service with CORS changes..."
...
echo "       -H 'Access-Control-Request-Headers: X-API-Key' \\"
echo "       -X OPTIONS $SERVICE_URL/api/v1/productos/activos -v"
echo ""
...
log_success "Inventario service redeployed successfully!"
