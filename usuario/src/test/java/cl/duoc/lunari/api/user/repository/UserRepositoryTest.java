...
class UserRepositoryTest {
    ...
    void save_shouldUpdateTimestamp_whenUserIsModified() {
        ...
        OffsetDateTime originalCreatedAt = userToUpdate.getCreatedAt();
        ...
        long timeDiffMillis = updatedUser.getUpdatedAt().toInstant().toEpochMilli() - 
                             originalUpdatedAt.toInstant().toEpochMilli();
        assertTrue(timeDiffMillis >= 50, 
            "updatedAt should be at least 50ms later than original. Difference was: " + timeDiffMillis + "ms");
