...
# LUNARi Usuario Service - Quick Redeploy Script
...
# Header
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}  Usuario Service - Redeploy${NC}"
echo -e "${GREEN}========================================${NC}\n"
...
# Build the new image
log_info "Building Usuario Service with CORS changes..."
...
echo "       -X OPTIONS $SERVICE_URL/api/v1/auth/login -v"
echo ""
...
log_success "Usuario service redeployed successfully!"
